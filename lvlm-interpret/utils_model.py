...
setattr(LlavaMistralForCausalLM, func_to_enable_grad, torch.enable_grad(getattr(LlavaMistralForCausalLM, func_to_enable_grad)))
...
def get_tokenizer_processor_model(args):
    ...
    model.model.vision_tower.vision_tower.config.output_attentions = True
